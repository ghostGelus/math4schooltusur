<template>
	<div class='more_threads'>
		<div class='more_threads__header'>Другие посты в этой категории '{{category.name}}'</div>
		...
		<template v-else>
			<div class='more_threads__thread more_threads__thread--header'>
				<div class='more_threads__name'>Пост</div>
				<div class='more_threads__date_created'>Дата публикации</div>
			</div>
