		...
		>
			...
			<div class='notification_button__menu'>
				...
				<div class='notification_button__menu__item__header'>
					<span v-if='notification.type === "mention"'>Новое упоминание</span>
					<span v-else-if='notification.type === "reply"'>Ответ на ваш пост</span>
					<span>
				...
				<div>
					<span v-if='isYouOrDeleted(notification.PostNotification.User)'>
						{{ notification.PostNotification.User ? 'Вы' : '[удалены]' }}
					</span>
